...
const FaceVerificationPage = () => {
  ...
  // Get pending signup data from location.state
  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      console.log('Face descriptor extracted, registering user...');
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center">
      <div className="sm:mx-auto sm:w-full sm:max-w-lg">
        <div className="py-8 px-4 sm:px-10">
          <div className="mb-6">
            <Link to="/signup" className="flex items-center text-blue-600 hover:text-blue-800 transition-colors">
          ...
          <div className="text-center mb-8">
            ...
            >
              Position your face in the frame and capture to complete registration
            </motion.p>
          </div>
